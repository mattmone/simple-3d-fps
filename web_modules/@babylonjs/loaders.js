import { c as AbstractMesh, d as StandardMaterial, H as HemisphericLight, C as Camera, M as Mesh, i as MultiMaterial, G as Geometry, V as VertexData, T as TransformNode, L as Light } from '../common/standardMaterial-cad1cb30.js';
import { T as Tools, O as Observable, M as Matrix, h as Vector4, V as Vector3, j as Vector2, Z as Texture, Y as Effect, i as Color4, l as Color3, J as Material, m as Engine, Q as Quaternion, I as SubMesh, g as VertexBuffer, b as __extends, K as Buffer, aW as LoadFileError, aF as SphericalHarmonics, aj as SphericalPolynomial, a4 as Scalar } from '../common/texture-1533b140.js';
import { i as AssetContainer, d as SceneLoader, c as ShaderMaterial, h as Skeleton, A as Animation, D as DirectionalLight, v as PointLight, e as SpotLight, b as FreeCamera, B as Bone, M as MorphTargetManager, G as MorphTarget, j as AnimationGroup, g as PBRMaterial, H as Deferred, w as SceneLoaderProgressEvent, p as AnimationKeyInterpolation, y as RawCubeTexture, z as DracoCompression, W as WeightedSound, o as AnimationEvent, S as Sound } from '../common/deferred-d38009ed.js';
    ...
    GLTFLoader.prototype._loadVertexAccessorAsync = function (context, accessor, kind) {
        ...
        // HACK: If byte offset is not a multiple of component type byte length then load as a float array instead of using Babylon buffers.
            ...
            accessor._babylonVertexBuffer = this._loadVertexBufferViewAsync(bufferView_1, kind).then(function (babylonBuffer) {
                ...
                return new VertexBuffer(_this._babylonScene.getEngine(), babylonBuffer, kind, false, false, bufferView_1.byteStride, false, accessor.byteOffset, size, accessor.componentType, accessor.normalized, true);
            });
        }
        return accessor._babylonVertexBuffer;
    };
...
var NAME$1 = "KHR_draco_mesh_compression";
/**
...
var KHR_draco_mesh_compression = /** @class */ (function () {
    ...
    function KHR_draco_mesh_compression(loader) {
        ...
        this.name = NAME$1;
        /** Defines whether this extension is enabled. */
        this.enabled = DracoCompression.DecoderAvailable;
        this._loader = loader;
    }
    /** @hidden */
...
GLTFLoader$1.RegisterExtension(NAME$1, function (loader) { return new KHR_draco_mesh_compression(loader); });

var NAME$2 = "KHR_lights_punctual";
var LightType;
(function (LightType) {
...
GLTFLoader$1.RegisterExtension(NAME$2, function (loader) { return new KHR_lights(loader); });

var NAME$3 = "KHR_materials_pbrSpecularGlossiness";
/**
...
GLTFLoader$1.RegisterExtension(NAME$3, function (loader) { return new KHR_materials_pbrSpecularGlossiness(loader); });

var NAME$4 = "KHR_materials_unlit";
/**
...
GLTFLoader$1.RegisterExtension(NAME$4, function (loader) { return new KHR_materials_unlit(loader); });

var NAME$5 = "KHR_texture_transform";
/**
...
GLTFLoader$1.RegisterExtension(NAME$5, function (loader) { return new KHR_texture_transform(loader); });

var NAME$6 = "MSFT_audio_emitter";
/**
...
GLTFLoader$1.RegisterExtension(NAME$6, function (loader) { return new MSFT_audio_emitter(loader); });
...
GLTFLoader$1.RegisterExtension(NAME$7, function (loader) { return new MSFT_lod(loader); });

var NAME$8 = "MSFT_minecraftMesh";
/** @hidden */
...
GLTFLoader$1.RegisterExtension(NAME$8, function (loader) { return new MSFT_minecraftMesh(loader); });

var NAME$9 = "MSFT_sRGBFactors";
/** @hidden */
...
GLTFLoader$1.RegisterExtension(NAME$9, function (loader) { return new MSFT_sRGBFactors(loader); });
...
export { index as GLTF1, index$1 as GLTF2, GLTFFileLoader, GLTFLoaderAnimationStartMode, GLTFLoaderCoordinateSystemMode, GLTFLoaderState, MTLFileLoader, OBJFileLoader, STLFileLoader };
